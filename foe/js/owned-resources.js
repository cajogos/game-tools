...
// Iron Age
ownedResources.push({ name: "cloth", amount: 50 });
...
ownedResources.push({ name: "alabaster", amount: 88 });

// High Middle Ages
ownedResources.push({ name: "bricks", amount: 37 });
ownedResources.push({ name: "glass", amount: 82 });
ownedResources.push({ name: "dried herbs", amount: 5 });
ownedResources.push({ name: "ropes", amount: 36 });
ownedResources.push({ name: "salt", amount: 5 });

// Late Middle Ages
ownedResources.push({ name: "basalt", amount: 10 });
ownedResources.push({ name: "brass", amount: 22 });
ownedResources.push({ name: "gunpowder", amount: 13 });
